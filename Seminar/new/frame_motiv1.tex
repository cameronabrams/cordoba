\begin{frame}[fragile]{Time and Length Scales of Some Importance}
\begin{tikzpicture}%[scale=1.5]
\node[anchor=south west,inner sep=0] (image) at (0,0.05) 
{\includegraphics[width=\textwidth]{time-vs-length.png}};
\begin{scope}[x={(image.south east)},y={(image.north west)}]
\draw[green!80!black,thick,rounded corners] (0.2,0.125) rectangle (0.32,0.375);
\draw[green!80!black,thick] (0.26,0.275) node {MD};
