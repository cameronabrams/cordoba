...
\path(nw) 
    ...
    ++(0,-0.1\bbh) node(graphic1)[anchor=north west]{
        \includegraphics[width=0.25\textwidth]{../Mueller String Method/sm0.pdf}
    }
    ++(0.25\bbw,0) node(graphic2)[anchor=north west]{
        \includegraphics[width=0.25\textwidth]{../Mueller String Method/sm1.pdf}
    }
    ++(0.25\bbw,0) node(graphic3)[anchor=north west]{
        \includegraphics[width=0.25\textwidth]{../Mueller String Method/sm2.pdf}
    }
    ++(0.25\bbw,0) node(graphic4)[anchor=north west]{
        \includegraphics[width=0.25\textwidth]{../Mueller String Method/sm3.pdf}    
    };
\path(cp) 
